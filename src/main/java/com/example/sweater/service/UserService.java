...
public class UserService implements UserDetailsService {
    ...
    public boolean addUser(User user) {
        ...
        if (userFromDb != null) {  // возвращаем false (выходим из метода) если пользователь существует
            return false;
        }
        user.setActive(true);
    ...
    public boolean activateUser(String code) {
        ...
        if (user == null) {
            return false; // если не находит пользователя по данному коду активации,завершаем метод с false
        }
