...
public class UserController {
    ...
    @PreAuthorize("hasAuthority('ADMIN')") //проверка роль пользователя прежде чем выполнится данный метод
    // mapping,позволяющий получить самого пользователя по id с указанием внизу в @PathVariable не Long id а User user
    @GetMapping("{user}")
